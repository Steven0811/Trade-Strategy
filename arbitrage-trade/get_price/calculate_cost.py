...
3. 期貨交易稅(買賣皆要): 契約金額 * 0.0002
4. 期貨交易手續費(買賣皆要): 依券商不同
計算成本時，期貨數量為 1 口，現股數量為 2000 股
由於一口期貨為 2 張股票，所以可算出每股平均成本為總成本 / 2000
'''

def calculate_cost(stock_price: float, future_price: float, future_fee: int) -> float:
    stock_tax = stock_price * 2000 * 0.003
    stock_fee = stock_price * 2000 * 0.001425 * 2
    future_tax = future_price * 1 * 0.00002 * 2
    future_fee = future_fee * 2
